...
func defaultSpecs() []CommandSpec {
	return []CommandSpec{
		...
		{Name: "init", Use: "init", Short: "Initialize the awiki-cli workspace and config.yaml", Phase: "phase1", Implemented: true, Handler: "init", SideEffect: true, Outputs: []string{"json", "pretty", "table"}, Flags: []FlagSpec{{Name: "domain", Type: "string", Usage: "Active DID / Handle domain for this workspace"}, {Name: "service-base-url", Type: "string", Usage: "Advanced override for the public API base URL"}, {Name: "anp-service-endpoint", Type: "string", Usage: "Advanced override for ANPMessageService.serviceEndpoint"}, {Name: "anp-service-did", Type: "string", Usage: "Advanced override for ANPMessageService.serviceDid"}}},
		...
		{Name: "config.services", Use: "services", Short: "Inspect and update hosted-domain service settings", Phase: "phase1", Implemented: true},
		{Name: "config.services.show", Use: "show", Short: "Show active hosted-domain service settings", Phase: "phase1", Implemented: true, Handler: "config.services.show", Outputs: []string{"json", "pretty", "table"}},
		{Name: "config.services.set", Use: "set", Short: "Update active hosted-domain service settings", Phase: "phase1", Implemented: true, Handler: "config.services.set", SideEffect: true, Outputs: []string{"json", "pretty", "table"}, Flags: []FlagSpec{{Name: "domain", Type: "string", Usage: "Active DID / Handle domain for this workspace"}, {Name: "service-base-url", Type: "string", Usage: "Advanced override for the public API base URL"}, {Name: "anp-service-endpoint", Type: "string", Usage: "Advanced override for ANPMessageService.serviceEndpoint"}, {Name: "anp-service-did", Type: "string", Usage: "Advanced override for ANPMessageService.serviceDid"}}},
