...
func defaultSpecs() []CommandSpec {
	return []CommandSpec{
		...
		{Name: "upgrade", Use: "upgrade", Short: "Inspect or apply awiki-cli self update state", Phase: "phase2", Implemented: true, Handler: "upgrade", Outputs: []string{"json", "pretty", "table"}},
		{Name: "upgrade.check", Use: "check", Short: "Check for newer awiki-cli versions", Phase: "phase2", Implemented: true, Handler: "upgrade.check", Outputs: []string{"json", "pretty", "table"}},
		{Name: "upgrade.apply", Use: "apply", Short: "Download and activate the latest awiki-cli binary", Phase: "phase2", Implemented: true, Handler: "upgrade.apply", SideEffect: true, Outputs: []string{"json", "pretty", "table"}},
		{Name: "upgrade.status", Use: "status", Short: "Show local self update state", Phase: "phase2", Implemented: true, Handler: "upgrade.status", Outputs: []string{"json", "pretty", "table"}},
		{Name: "skill", Use: "skill", Short: "Inspect, render, and export awiki-cli skill bundle content", Phase: "phase3", Implemented: true},
		{Name: "skill.index", Use: "index", Short: "List embedded skill documents", Phase: "phase3", Implemented: true, Handler: "skill.index", Outputs: []string{"json", "pretty", "table"}, Flags: []FlagSpec{{Name: "kind", Type: "string", Usage: "Filter by skill document kind"}, {Name: "tag", Type: "string", Usage: "Filter by tag"}}},
		{Name: "skill.get", Use: "get <PATH>", Short: "Read one embedded skill document", Phase: "phase3", Implemented: true, Handler: "skill.get", Outputs: []string{"json", "pretty"}, Flags: []FlagSpec{{Name: "write", Type: "string", Usage: "Write the rendered document to a file"}, {Name: "cache", Type: "string", Usage: "Cache mode", Default: "auto", Choices: []string{"auto", "refresh", "bypass"}}}},
		{Name: "skill.sync", Use: "sync", Short: "Render and sync the public root skill", Phase: "phase3", Implemented: true, Handler: "skill.sync", SideEffect: true, Outputs: []string{"json", "pretty"}, Flags: []FlagSpec{{Name: "dir", Type: "string", Usage: "Target skill root directory"}, {Name: "force", Type: "bool", Usage: "Force overwrite after backing up existing files"}, {Name: "adopt", Type: "bool", Usage: "Adopt an unmanaged existing target after backup"}}},
		{Name: "skill.export", Use: "export", Short: "Export an offline skill package", Phase: "phase3", Implemented: true, Handler: "skill.export", SideEffect: true, Outputs: []string{"json", "pretty"}, Flags: []FlagSpec{{Name: "dir", Type: "string", Usage: "Output directory", Required: true}, {Name: "all", Type: "bool", Usage: "Export all embedded references"}, {Name: "path", Type: "string", Usage: "Export a single embedded reference path"}, {Name: "include-root", Type: "bool", Usage: "Include the rendered root skill"}, {Name: "clean", Type: "bool", Usage: "Remove the output directory before exporting"}}},
