...
func defaultSpecs() []CommandSpec {
	return []CommandSpec{
		...
		{Name: "runtime.status", Use: "status", Short: "Show runtime status", Phase: "phase6", Implemented: true, Handler: "runtime.status", Outputs: []string{"json", "pretty", "table"}},
		{Name: "runtime.setup", Use: "setup", Short: "Run runtime bootstrap and migration checks", Phase: "phase6", Implemented: true, Handler: "runtime.setup", SideEffect: true, Outputs: []string{"json", "pretty"}, Flags: []FlagSpec{{Name: "mode", Type: "string", Usage: "Runtime mode", Choices: []string{"http", "websocket"}}}},
		{Name: "runtime.mode", Use: "mode", Short: "Inspect or update runtime mode", Phase: "phase6", Implemented: false},
		{Name: "runtime.mode.get", Use: "get", Short: "Get the current runtime mode", Phase: "phase6", Implemented: true, Handler: "runtime.mode.get", Outputs: []string{"json", "pretty", "table"}},
		{Name: "runtime.mode.set", Use: "set <MODE>", Short: "Set the runtime mode", Phase: "phase6", Implemented: true, Handler: "runtime.mode.set", SideEffect: true, Outputs: []string{"json", "pretty"}},
		{Name: "runtime.listener", Use: "listener", Short: "Manage the realtime listener service", Phase: "phase6", Implemented: false},
		{Name: "runtime.listener.status", Use: "status", Short: "Show listener status", Phase: "phase6", Implemented: true, Handler: "runtime.listener.status", Outputs: []string{"json", "pretty", "table"}},
		{Name: "runtime.listener.install", Use: "install", Short: "Install the listener service", Phase: "phase6", Implemented: true, Handler: "runtime.listener.install", SideEffect: true, Outputs: []string{"json", "pretty"}},
		{Name: "runtime.listener.start", Use: "start", Short: "Start the listener service", Phase: "phase6", Implemented: true, Handler: "runtime.listener.start", SideEffect: true, Outputs: []string{"json", "pretty"}},
		{Name: "runtime.listener.stop", Use: "stop", Short: "Stop the listener service", Phase: "phase6", Implemented: true, Handler: "runtime.listener.stop", SideEffect: true, Outputs: []string{"json", "pretty"}},
		{Name: "runtime.listener.restart", Use: "restart", Short: "Restart the listener service", Phase: "phase6", Implemented: true, Handler: "runtime.listener.restart", SideEffect: true, Outputs: []string{"json", "pretty"}},
		{Name: "runtime.listener.uninstall", Use: "uninstall", Short: "Uninstall the listener service", Phase: "phase6", Implemented: true, Handler: "runtime.listener.uninstall", SideEffect: true, Outputs: []string{"json", "pretty"}},
