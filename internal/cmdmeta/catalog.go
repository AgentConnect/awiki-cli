...
func defaultSpecs() []CommandSpec {
	return []CommandSpec{
		...
		{Name: "id.status", Use: "status", Short: "Show identity status", Phase: "phase2", Implemented: false, Handler: "stub", Outputs: []string{"json", "pretty"}},
		{Name: "id.create", Use: "create", Short: "Create a new DID identity", Phase: "phase2", Implemented: false, Handler: "stub", SideEffect: true, Outputs: []string{"json", "pretty"}, Flags: []FlagSpec{{Name: "name", Type: "string", Usage: "Identity display name", Required: true}, {Name: "identity", Type: "string", Usage: "Identity alias override"}}},
		{Name: "id.register", Use: "register", Short: "Register a handle for the current identity", Phase: "phase2", Implemented: false, Handler: "stub", SideEffect: true, Outputs: []string{"json", "pretty"}, Flags: []FlagSpec{{Name: "handle", Type: "string", Usage: "Handle local part", Required: true}, {Name: "phone", Type: "string", Usage: "Phone number for registration"}, {Name: "email", Type: "string", Usage: "Email address for registration"}, {Name: "otp", Type: "string", Usage: "Verification code"}, {Name: "invite-code", Type: "string", Usage: "Invite code if required"}}},
		...
		{Name: "id.resolve", Use: "resolve", Short: "Resolve a DID or handle", Phase: "phase2", Implemented: false, Handler: "stub", Outputs: []string{"json", "pretty", "table"}, Flags: []FlagSpec{{Name: "handle", Type: "string", Usage: "Handle to resolve"}, {Name: "did", Type: "string", Usage: "DID to resolve"}}},
		{Name: "id.recover", Use: "recover", Short: "Recover a handle with phone verification", Phase: "phase2", Implemented: false, Handler: "stub", SideEffect: true, Outputs: []string{"json", "pretty"}, Flags: []FlagSpec{{Name: "handle", Type: "string", Usage: "Handle local part", Required: true}, {Name: "phone", Type: "string", Usage: "Recovery phone number", Required: true}, {Name: "otp", Type: "string", Usage: "Verification code", Required: true}}},
		{Name: "id.list", Use: "list", Short: "List local identities", Phase: "phase2", Implemented: false, Handler: "stub", Outputs: []string{"json", "pretty", "table"}},
		{Name: "id.current", Use: "current", Short: "Show the default identity", Phase: "phase2", Implemented: false, Handler: "stub", Outputs: []string{"json", "pretty", "table"}},
		{Name: "id.use", Use: "use <identity>", Short: "Switch the default identity", Phase: "phase2", Implemented: false, Handler: "stub", SideEffect: true, Outputs: []string{"json", "pretty"}},
		{Name: "id.profile", Use: "profile", Short: "Read or update DID profile data", Phase: "phase2", Implemented: false},
		{Name: "id.profile.get", Use: "get", Short: "Get DID profile data", Phase: "phase2", Implemented: false, Handler: "stub", Outputs: []string{"json", "pretty", "table"}, Flags: []FlagSpec{{Name: "self", Type: "bool", Usage: "Read the active identity profile"}, {Name: "handle", Type: "string", Usage: "Read a profile by handle"}, {Name: "did", Type: "string", Usage: "Read a profile by DID"}}},
		{Name: "id.profile.set", Use: "set", Short: "Update DID profile data", Phase: "phase2", Implemented: false, Handler: "stub", SideEffect: true, Outputs: []string{"json", "pretty"}, Flags: []FlagSpec{{Name: "display-name", Type: "string", Usage: "Profile display name"}, {Name: "bio", Type: "string", Usage: "Profile bio"}, {Name: "tags", Type: "string", Usage: "Comma-separated tags"}, {Name: "markdown", Type: "string", Usage: "Inline markdown body"}, {Name: "markdown-file", Type: "string", Usage: "Markdown file path"}}},
		...
		{Name: "debug.db", Use: "db", Short: "Database inspection helpers", Phase: "phase1", Implemented: false},
		{Name: "debug.db.query", Use: "query <SQL>", Short: "Execute a local SQLite query", Phase: "phase7", Implemented: false, Handler: "stub", Outputs: []string{"json", "pretty", "table"}},
