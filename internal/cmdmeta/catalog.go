...
func defaultSpecs() []CommandSpec {
	return []CommandSpec{
		...
		{Name: "msg.mail", Use: "mail", Short: "Mail commands", Phase: "phase5", Implemented: true},
		{Name: "msg.mail.inbox", Use: "inbox", Short: "List mail inbox messages", Phase: "phase5", Implemented: true, Handler: "mail.inbox", Outputs: []string{"json", "pretty", "table"}, Flags: []FlagSpec{{Name: "folder", Type: "string", Usage: "Mailbox folder", Default: "inbox"}, {Name: "unread", Type: "bool", Usage: "Only unread messages"}, {Name: "limit", Type: "int", Usage: "Maximum number of results", Default: "20"}, {Name: "offset", Type: "int", Usage: "Pagination offset", Default: "0"}}},
		{Name: "msg.mail.notify", Use: "notify", Short: "List recent mail notification messages", Phase: "phase5", Implemented: true, Handler: "mail.notify", Outputs: []string{"json", "pretty", "table"}, Flags: []FlagSpec{{Name: "limit", Type: "int", Usage: "Maximum number of notifications", Default: "20"}}},
		{Name: "msg.mail.read", Use: "read", Short: "Read one mail message", Phase: "phase5", Implemented: true, Handler: "mail.read", Outputs: []string{"json", "pretty", "table"}, Flags: []FlagSpec{{Name: "id", Type: "string", Usage: "Message id", Required: true}}},
		{Name: "msg.mail.mark-read", Use: "mark-read [MESSAGE_ID...]", Short: "Mark mail messages as read", Phase: "phase5", Implemented: true, Handler: "mail.mark-read", SideEffect: true, Outputs: []string{"json", "pretty"}},
		{Name: "msg.mail.account", Use: "account", Short: "Show mailbox account info", Phase: "phase5", Implemented: true, Handler: "mail.account", Outputs: []string{"json", "pretty", "table"}},
		{Name: "msg.mail.send", Use: "send", Short: "Send a mail message", Phase: "phase5", Implemented: true, Handler: "mail.send", SideEffect: true, Outputs: []string{"json", "pretty"}, Flags: []FlagSpec{{Name: "to", Type: "string", Usage: "Recipient addresses (comma-separated)", Required: true}, {Name: "cc", Type: "string", Usage: "CC addresses (comma-separated)"}, {Name: "subject", Type: "string", Usage: "Mail subject", Required: true}, {Name: "body", Type: "string", Usage: "Plain text body", Required: true}, {Name: "html", Type: "string", Usage: "HTML body"}}},
		{Name: "msg.mail.attachment", Use: "attachment", Short: "Mail attachment commands", Phase: "phase5", Implemented: true},
		{Name: "msg.mail.attachment.download", Use: "download", Short: "Download a mail attachment", Phase: "phase5", Implemented: true, Handler: "mail.attachment.download", SideEffect: true, Outputs: []string{"json", "pretty"}, Flags: []FlagSpec{{Name: "message-id", Type: "string", Usage: "Message id", Required: true}, {Name: "attachment-index", Type: "int", Usage: "Attachment index (0-based)", Default: "0"}, {Name: "output", Type: "string", Usage: "Output file path"}}},
