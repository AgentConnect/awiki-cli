...
func defaultSpecs() []CommandSpec {
	return []CommandSpec{
		...
		{Name: "group.e2ee.publish-key-package", Use: "publish-key-package", Short: "Plan a test-only group E2EE KeyPackage publish", Phase: "phase6", Implemented: true, Handler: "group.e2ee.publish-key-package", SideEffect: true, Outputs: []string{"json", "pretty"}, Flags: []FlagSpec{{Name: "device", Type: "string", Usage: "Local MLS device id", Default: "default"}, {Name: "contract-test", Type: "bool", Usage: "Use non-cryptographic contract-test artifacts"}}},
		{Name: "group.e2ee.pending", Use: "pending", Short: "Inspect pending group E2EE contract-test work", Phase: "phase6", Implemented: true, Handler: "group.e2ee.pending", Outputs: []string{"json", "pretty", "table"}},
		{Name: "group.e2ee.repair", Use: "repair", Short: "Plan a group E2EE contract-test repair pass", Phase: "phase6", Implemented: true, Handler: "group.e2ee.repair", SideEffect: true, Outputs: []string{"json", "pretty"}, Flags: []FlagSpec{{Name: "group", Type: "string", Usage: "Group DID", Required: true}}},
