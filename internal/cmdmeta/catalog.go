...
func defaultSpecs() []CommandSpec {
	return []CommandSpec{
		...
		{Name: "group.show", Use: "show", Short: "Show group details", Aliases: []string{"get"}, Phase: "phase5", Implemented: true, Handler: "group.show", Outputs: []string{"json", "pretty", "table"}, Flags: []FlagSpec{{Name: "group", Type: "string", Usage: "Group DID", Required: true}}},
