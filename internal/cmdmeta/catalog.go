...
func defaultSpecs() []CommandSpec {
	return []CommandSpec{
		...
		{Name: "init", Use: "init", Short: "Initialize the awiki-cli workspace and config.json", Phase: "phase1", Implemented: true, Handler: "init", SideEffect: true, Outputs: []string{"json", "pretty", "table"}},
