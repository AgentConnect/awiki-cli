...
func (t *HTTPTransport) SendGroupE2EE(ctx context.Context, groupDID string, cipher map[string]any, operationID string, messageID string) (*groupSendResult, error) {
	params, err := BuildGroupE2EESendRPCParams(t.auth.record, nil, groupDID, cipher, operationID, messageID)
	if err != nil {
		return nil, err
	}
	meta, _ := params["meta"].(map[string]any)
...
func (t *HTTPTransport) GetGroupE2EERecoveryKeyPackage(ctx context.Context, groupDID string, targetDID string, deviceID string) (map[string]any, error) {
	serviceDID, err := t.GetMessageServiceDID(ctx)
	if err != nil {
		return nil, err
	}
	params, err := BuildGroupE2EEGetRecoveryKeyPackageRPCParams(t.auth.record, nil, serviceDID, groupDID, targetDID, deviceID)
	if err != nil {
		return nil, err
	}
	return t.rpcMapCall(ctx, "group.e2ee.get_key_package", params)
...
func (t *HTTPTransport) CreateGroupE2EE(ctx context.Context, groupDID string, mlsHead map[string]any) (map[string]any, error) {
	...
	params, err := BuildGroupE2EECreateRPCParams(t.auth.record, nil, serviceDID, groupDID, mlsHead)
	if err != nil {
		return nil, err
	}
...
func (t *HTTPTransport) RecoverGroupE2EEMember(ctx context.Context, groupDID string, memberDID string, deviceID string, prepared map[string]any, leasedPackage map[string]any) (map[string]any, error) {
	params, err := BuildGroupE2EERecoverMemberRPCParams(t.auth.record, nil, groupDID, memberDID, deviceID, prepared, leasedPackage)
	if err != nil {
		return nil, err
	}
...
func (t *HTTPTransport) LeaveGroupE2EE(ctx context.Context, groupDID string, preparedCommit map[string]any) (map[string]any, error) {
	params, err := BuildGroupE2EELeaveRPCParams(t.auth.record, nil, groupDID, preparedCommit)
	if err != nil {
		return nil, err
	}
	return t.rpcMapCall(ctx, "group.e2ee.leave", params)
}

func (t *HTTPTransport) PullGroupE2EENotices(ctx context.Context, groupDID string, limit int, markDelivered bool) (map[string]any, error) {
	params, err := BuildGroupE2EENoticeRPCParams(t.auth.record, nil, groupDID, limit, markDelivered, nil)
	if err != nil {
		return nil, err
	}
...
func (t *HTTPTransport) MarkGroupE2EENoticesDelivered(ctx context.Context, groupDID string, noticeIDs []string) (map[string]any, error) {
	params, err := BuildGroupE2EENoticeRPCParams(t.auth.record, nil, groupDID, len(noticeIDs), true, noticeIDs)
	if err != nil {
		return nil, err
	}
	return t.rpcMapCall(ctx, "group.e2ee.notice", params)
