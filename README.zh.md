...
快捷入口： [Onboarding](./onboarding.md) · [命令树](./docs/architecture/awiki-command-v2.md) · [架构说明](./docs/architecture/awiki-v2-architecture.md)
...
- 中文 Onboarding： [onboarding.md](./onboarding.md)
